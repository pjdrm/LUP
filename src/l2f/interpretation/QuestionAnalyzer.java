 ...
 * 
 * @author Sergio Curto
 * Unless special configuration is required, access to the instance of this class should
 * be done through the getInstance method
 */
public class QuestionAnalyzer {
	private static QuestionAnalyzer instance = null;
